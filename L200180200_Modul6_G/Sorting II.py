...
m0 = MhsTIF('Ika', 9, 'Sukoharjo', 240000)
m1 = MhsTIF('Budi', 10, 'Sragen', 230000)
m2 = MhsTIF('Ahmad', 23, 'Surakarta', 250000)
m3 = MhsTIF('Chandra', 45, 'Surakarta', 235000)
m4 = MhsTIF('Eka', 27, 'Boyolali', 240000)
m5 = MhsTIF('Fandi', 56, 'Salatiga', 250000)
m6 = MhsTIF('Deni', 2, 'Klaten', 245000)
m7 = MhsTIF('Galuh', 8, 'Wonogiri', 245000)
m8 = MhsTIF('Janto', 34, 'Klaten', 245000)
m9 = MhsTIF('Hasan', 60, 'Karanganyar', 270000)
m10 = MhsTIF('Khalid', 51, 'Purwodadi', 265000)
